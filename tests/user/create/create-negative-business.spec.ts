...
test.describe('User API - Create User Business-Level Negative Scenarios', () => {
  ...
  const BUSINESS_NEGATIVE_CASES: {field: keyof UserModel; value: string; reason: string; }[] = [
    { field: 'username', value: existingUser.username, reason: 'Duplicate username'},
